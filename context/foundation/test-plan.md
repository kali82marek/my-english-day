...
- **Reguły**:
  ...
  - **Guard „pusta lista → rzut” zostaje w generatorze** (T5.4, T2.4): po S-04 „zero kart po deduplikacji” będzie odrębnym, legalnym wynikiem warstwy zapisu — przeniesienie guarda zaczerwieni T5.4 i to jest sygnał do rozmowy, nie do usunięcia testu.
