...
| 2 | Kontrakty tras: własność, izolacja, dzień | Udowodnić, że użytkownik widzi i zmienia tylko swoje dane i właściwy dzień lokalny | #3, #6 | integration na poziomie tras (dwóch użytkowników, kontrolowany czas) | change opened | `context/changes/testing-route-contracts-ownership-day/` |
